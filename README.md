...
- Access on https://BoostifyGPT.vercel.app or run locally!
...
Visit [BoostifyGPT](https://BoostifyGPT.vercel.app) to try it out without installing, or follow these steps to run it locally:

### Prerequisites

You'll need the following tools installed on your computer to run BoostifyGPT locally.
...
```
$ git clone https://github.com/BoostifyGPT/BoostifyGPT.git
```
...
Congratulations! 🎉 You are now running BoostifyGPT locally on your machine.

## 🔑 API Key Configuration

To utilize BoostifyGPT, you'll need to acquire an API key for OpenAI. The app should prompt you to insert you key.
...
```
docker build -t BoostifyGPT:latest .
```

To run in a container:

```
docker run -it -p 3000:3000 BoostifyGPT:latest
```

## 🎤 Microphone Integration

BoostifyGPT makes chatting a breeze with its microphone integration! Activate your microphone using your browser's permissions, and BoostifyGPT will automatically convert your speech into text.
...
BoostifyGPT ensures your data privacy and security by letting you use your own API key. Your conversation with BoostifyGPT takes place directly between your browser and OpenAI's GPT-3 API, with no intermediary servers.
